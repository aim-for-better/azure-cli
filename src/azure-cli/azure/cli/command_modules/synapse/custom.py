...
def list_workspace(cmd, client):
    return client.list()


def list_workspace_by_resource_group(cmd, client, resource_group_name):
    return client.list_by_resource_group(resource_group_name)


def create_workspace(cmd, client, resource_group_name, workspace_name, account_url, file_system, \
                     sql_admin_login_user, sql_admin_login_password, location, tags=None,
...
def get_big_data_pool(cmd, client, resource_group_name, workspace_name, big_data_pool_name):
    return client.get(resource_group_name, workspace_name, big_data_pool_name)


def list_big_data_pool_by_workspace(cmd, client, resource_group_name, workspace_name):
    return client.list_by_workspace(resource_group_name, workspace_name)


def create_big_data_pool(cmd, client, resource_group_name, workspace_name, big_data_pool_name, location,
    ...
    return client.create_or_update(resource_group_name, workspace_name, big_data_pool_name, big_data_pool_info, force)


def delete_big_data_pool(cmd, client, resource_group_name, workspace_name, big_data_pool_name):
    return client.delete(resource_group_name, workspace_name, big_data_pool_name)
